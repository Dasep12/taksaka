...
class _LeaveRequestScreenState extends State<LeaveRequestScreen> {
  ...
  final List<String> _leaveTypes = ['Cuti Tahunan', 'Cuti Melahirkan', 'Cuti Besar', 'Cuti Menikah'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Pengajuan Cuti', style: TextStyle(fontSize: 16, color: Colors.white)),
